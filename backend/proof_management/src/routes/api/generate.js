...
var infoObject = {
  info: {
    title: "proof_management API",
    summary: "API to retrieve proofs for log_management API.",
    description: `This API can be used to validate log-messages created by the log_management service.
